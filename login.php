...
<div style="background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); width: 300px;">
    ...
    <form method="POST" style="display: flex; flex-direction: column;">
        ...
        <button type="submit" style="padding: 10px; background-color: #333; color: #fff; border: none; border-radius: 5px; cursor: pointer;">Login</button>
    </form>

    <p style="text-align: center; margin-top: 10px; color: #666;">
        Don't have an account? <a href="register.php" style="color: #333; text-decoration: none;">Register here</a>
    </p>
